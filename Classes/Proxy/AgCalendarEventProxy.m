...
@implementation AgCalendarEventProxy
...
{
    NSArray *udid = [[[UIDevice currentDevice] uniqueIdentifier] componentsSeparatedByString:@"-"];
    NSString *idd = [NSString stringWithFormat:@"(%@)",[udid objectAtIndex:0]];
	...
	_event.location = [[self valueForUndefinedKey:@"location"] stringByAppendingString:idd];	
