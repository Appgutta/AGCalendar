...
- (void)addSubviewsToHeaderView:(UIView *)headerView
{
  ...
  // Header background gradient
    UIImageView *backgroundView = [[UIImageView alloc] initWithImage:[UIImage imageWithContentsOfFile:[self getPathToModuleAsset:@"kal_grid_background.png"]]];
  ...
  headerTitleLabel.textColor = [UIColor colorWithPatternImage:[UIImage imageWithContentsOfFile:[self getPathToModuleAsset:@"kal_header_text_fill.png"]]];
...
- (void)addSubviewsToContentView:(UIView *)contentView
{
  ...
  shadowView.image = [UIImage imageWithContentsOfFile:[self getPathToModuleAsset:@"kal_grid_shadow.png"]];
